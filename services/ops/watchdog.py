...
JOBS: tuple[MonitoredJob, ...] = (
    ...
    MonitoredJob("lea_roster_ingest", LOGS / "lea_roster_ingest.log", 8, "every 4 hours"),
    MonitoredJob("missing_person_sync", LOGS / "missing_person_sync.log", 2, "every 15 minutes"),
    MonitoredJob("score_humor", LOGS / "score_humor.log", 2, "hourly"),
