...
class HomepageLayoutTests(unittest.TestCase):
    ...
    def test_homepage_renders_newsroom_layout(self) -> None:
        ...
        self.assertIn('data-short-label="Missing"', html)
        self.assertIn('data-nav-location="mobile_tabbar" data-short-label="Missing" data-full-label="Missing Persons"', html)
        self.assertIn('data-nav-location="mobile_drawer" data-short-label="Missing" data-full-label="Missing Persons"', html)
        self.assertIn('/support?source=homepage_top', html)
        self.assertIn('id="mb-tab-bar"', html)
        self.assertIn('data-nav-track="1"', html)
        self.assertIn('id="pub-mobile-label-toggle"', html)
        self.assertIn('Show Full Labels', html)
        self.assertTrue('>Alerts<' in html or '>Subscribe<' in html)
